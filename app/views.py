...
class RegisterUser(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            msg = "Make sure you have entered the Email ID in valid format and both the passwords match with each other. Password must have letters, digits and special characters."
            form = RegistrationForm()
...
def login(request):
    allImages = ['https://cdn.britannica.com/s:800x450,c:crop/34/180334-138-4235A017/subordinate-meerkat-pack.jpg',
                 'https://media.wired.com/photos/593261cab8eb31692072f129/master/pass/85120553.jpg',
                 'http://wp.nathabblog.com/wp-content/uploads/2018/07/Panda_BradJosephs-4CROP_Web.jpg',
                 'https://images.pexels.com/photos/145939/pexels-photo-145939.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
                 'https://cdn.hswstatic.com/gif/animal-stereotype-orig.jpg',
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if(user.temp_blocked is False):
                ...
                if (int(p1) not in range(1, 10) or int(p2) not in range(1, 10) or int(p3) not in range(1, 10)):
                    error += 1
                    print(error)
                    if(error < 3):
                        x = allImages
            ...
            msg = 'Make sure you have entered the valid sequence'
            print(msg)
            error += 1
            if(error < 3):
                return redirect('level2')
